            ...
            <!-- <vs-col type="flex" vs-justify="right" vs-align="right" vs-w="4"> -->
              ...
              <vs-row vs-justify='top'>
               ...
               <vs-col type="flex" vs-justify="right" vs-align="right" vs-w="6">
                  ...
                  <transition mode="out-in" enter-active-class="animate__animated animate__fadeInRight" leave-active-class="animate__animated animate__fadeOutLeft">
                    <vs-card class="cardx" style="border-style: solid; border-color:orange; border-width: thin;" v-if="fetched.col_generated">
                      <div slot="header"><h4>Dominant colors in this painting</h4></div>
                  ...
                  <vs-col type="flex" vs-justify="right" vs-align="right" vs-w="6">
                    ...
                    <vs-row vs-justify='top'>
                      <transition mode="out-in" enter-active-class="animate__animated animate__fadeInRight" leave-active-class="animate__animated animate__fadeOutLeft">
                        <vs-card class="cardx" style="border-style: solid; border-color:orange; border-width: thin;" v-if="fetched.summary">
                          <div slot="header"><h4>{{ genre }} on Wikipedia</h4></div>
                            <div style="font-size: 11pt">
                              {{ summary }}
                            </div>
                    ...
                    <vs-row vs-justify='bottom'>
                      <transition name="slide-fade">
                        <vs-card class="cardx" style="border-style: solid; border-color:orange; border-width: thin;" v-if="fetched.related_terms" >
                          <div slot="header"><h4>Related terms</h4></div>
                          <div>
                            {{ related_terms }}
                          </div>
          ...
          <vs-row vs-justify="top">
            ...
            <vs-col type="flex" vs-justify="left" vs-align="left" vs-w="3">
             ...
             <transition mode="out-in" enter-active-class="animate__animated animate__fadeInUp" leave-active-class="animate__animated animate__fadeOutDown">
                  ...
                  <vs-card class="cardx" style="border-style: solid; border-color:blue; border-width: thin;" v-if="fetched.histograms">
              ...
              <transition mode="out-in" enter-active-class="animate__animated animate__fadeInRight" leave-active-class="animate__animated animate__fadeOutLeft">
              <vs-card class="cardx" style="border-style: solid; border-color:blue; border-width: thin;" v-if="fetched.line_chart" >
            ...
            <vs-col type="flex" vs-justify="left" vs-align="left" vs-w="3">
             ...
             <transition mode="out-in" enter-active-class="animate__animated animate__fadeInUp" leave-active-class="animate__animated animate__fadeOutDown">
                  ...
                  <vs-card class="cardx" style="border-style: solid; border-color:orange; border-width: thin;" v-if="fetched.histograms">
                    <div slot="header"><h3>Distribution of dominant colors: {{selected_artist}}</h3></div>
                    <zingchart
                    ref="style_hist"
                    :data="style_hist_data"
              ...
              <transition mode="out-in" enter-active-class="animate__animated animate__fadeInRight" leave-active-class="animate__animated animate__fadeOutLeft">
              <vs-card class="cardx" style="border-style: solid; border-color:orange; border-width: thin;" v-if="fetched.line_chart" >
                <div slot="header"><h3>Dominant colors over the years: {{selected_artist}}</h3></div>
